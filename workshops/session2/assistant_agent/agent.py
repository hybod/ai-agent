...
from assistant_agent.sub_agents.sequential_agent import sequential_service_agent
from assistant_agent.prompts import CUSTOMER_SERVICE_AGENT_PROMPT, PRE_PROCESS_AGENT_PROMPT
...
customer_service_agent = Agent(
    ...
    description=("你是一个智能客户，根据用户需求，回答用户问题"),
